    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse opacityScroll" id="navbarSupportedContent">
        <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
          ...
          <li class="nav-item">
            <a class="nav-link link text-black display-4" href="./inscription.php">Inscription</a>
          </li>
          <li class="nav-item">
...
<div id="contenu">
    <form action="action.php" method="post">
        ...
        <p>Votre mot de passe : <input type="password" name="mdp1" /></p>
        <p>Confirmation de votre mot de passe : <input type="password" name="mdp2" /></p>
