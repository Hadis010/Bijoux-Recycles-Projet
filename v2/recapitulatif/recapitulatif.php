...
if ($result == false) {
    ...
    while ($suj = $result->fetch_assoc()) {
        ...
        echo '<h2>' . $suj['suj_intitule'] . '</h2>';

        $requete1 = "SELECT * FROM t_fichier_fic WHERE suj_numero = {$suj['suj_numero']}";
        ...
        if ($result1->num_rows > 0) {
            ...
            while ($fic = $result1->fetch_assoc()) {
                ...
                echo '<div class="col">';
                echo '<a href="fiche.php?code=' . $fic['fic_code'] . '">';
                echo '<div class="card custom-card mb-3" style="max-width: 200px;">';
                echo '<div class="card-body">';
                echo '<h5 class="card-title">' . $fic['fic_label'] . '</h5>';
                echo '<img src="../images/'. $fic['fic_ficimg'] . '" class="card-img-top" alt="Miniature">';
                echo '</div>';
                echo '</div>';
                echo '</a>';
                echo '</div>';
